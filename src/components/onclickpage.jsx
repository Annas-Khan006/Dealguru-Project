...
const Onclickpage = () => {
  return (
    <div className="bg-gray-200">
      <div className="sm:h-[1000px] px-4 py-4">
      <div className="">
        <div className="bg-white rounded-lg w-full h-full px-4 hidden md:block lg:hidden">
          <img
            className="mx-auto pt-3 sm:w-[400px]"
            src="/src/assets/girls.jpg"
            alt="Girls"
          />
          <a href="#">
            <div className="border bg-blue-600 h-[50px] w-full mt-7 rounded-md flex items-center justify-center">
          ...
          <div className="flex flex-grow justify-between">
            <h1 className="text-black font-bold text-2xl pt-3">
              IKEA pyjamasparty - de 500 första får en värdekupong på 150 kr
            </h1>
            <div className="pt-3">
        ...
        <div className="bg-white rounded-lg w-full h-full px-4 block md:hidden">
          <img
            className="mx-auto pt-3 sm:w-[400px]"
            src="/src/assets/girls.jpg"
            alt="Girls"
        ...
        <div className="py-4">
          <div className="bg-white rounded-lg w-full h-full block lg:hidden px-4 py-4">
            ...
            <p className="pt-5">
              Detta är ett perfekt tillfälle att uppdatera hemmet med nya möbler
              och inredning. IKEA erbjuder ett brett sortiment av produkter som
              passar alla stilar och budgetar. Passa på att handla allt från
              bekväma sängar och mjuka kuddar till praktiska förvaringslösningar
              och trendiga dekorationer.
            </p>
            <p className="pt-5">
              Förutom att fynda nya favoriter kan du också njuta av en rolig dag
              med familj och vänner. Pyjamaspartyt är en unik upplevelse där du
              kan mingla med andra pyjamasälskare och kanske till och med få
              inspiration till ditt eget sovrum.
            </p>
            <p className="py-5">
              ...
              precis det du letat efter för att göra ditt hem ännu mysigare 🛋️.
            </p>
          </div>
        </div>
      </div>
      <div className="grid grid-cols-9 gap-4">
        ...
        <div className="lg:block hidden bg-white rounded-lg w-full h-[200px] col-span-5">
          ...
          <div className="py-4">
            <div className="bg-white rounded-lg w-full h-full lg:block px-4">
              <h1 className="font-bold text-black text-xl pt-5">
                Gäller den 31/8 i alla varuhus!
              </h1>
              <h2 className="font-semibold pt-5 text-lg text-[#313131]">
